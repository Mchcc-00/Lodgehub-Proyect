...
<body>
    ...
    <div class="contenedorReservas">
        <div class="subContenedorReservasBuscar">
            <div class="conjuntoBtnAtrasTitulo">
                <button class="editIconEstilo" id="retornarMainReserva" style="cursor:pointer;">
                    <img src="../../public/img/FLECHAmini.png" alt="Volver">
                </button>
                <h2>Nueva Reserva</h2>
            </div>

            <div class="contenedorBusquedaHue">
                <form id="buscadorHuesped" action="buscarHuesped.php" method="GET">
                    <fieldset class="estiloFieldsetReservas">
                        <legend>Buscar huesped</legend>
                        <div class="barComposicionEstilo">
                            <input class="estilobarBusquedaReservas" type="text" id="buscarHuesped" placeholder="Documento Huesped" name="buscarHuesped" minlength="10" maxlength="15" required>
                            <button class="estilobarBusquedaReservas" id="btnBuscarHuesped" type="submit">
                                <img src="../../public/img/LupaLight.png" alt="Lupa" id="iconoLupa">
                            </button>
                        </div>
                        <button class="estilobarBusquedaReservas" type="button" id="registrarHuesped">Nuevo Huesped</button>
                    </fieldset>
                </form>
            </div>
