...
<body>
    <div class="container-principal">
        ...
        <div class="header-imagen">
            <img class="imagen-hotel" src="https://images.unsplash.com/photo-1566073771259-6a8506099945?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80" alt="LodgeHub Plaza Hotel" />
            <div class="overlay-gradiente"></div>
            <div class="info-superpuesta">
                <h1 class="titulo-hotel">LodgeHub Plaza Hotel</h1>
        ...
        <div class="contenido-principal">
            ...
            <div class="grid-informacion">
                ...
                <div class="columna-descripcion">
                    ...
                    <p class="texto-descripcion">Hotel moderno ubicado en el corazón de Bogotá, ofreciendo servicios de primera clase para huéspedes de negocios y turismo. Contamos con habitaciones elegantes, centro de conferencias, gimnasio, spa y restaurante gourmet. Nuestra ubicación estratégica permite fácil acceso a los principales centros comerciales y sitios de interés de la ciudad.</p>
                </div>
                    ...
                    <div class="lista-contactos">
                        ...
                        <div class="item-contacto">
                            ...
                            <div class="info-contacto">
                                ...
                                <span class="valor-contacto">900123456-1</span>
                            </div>
                        </div>
                        ...
                        <div class="item-contacto">
                            ...
                            <div class="info-contacto">
                                <span class="etiqueta-contacto">Documento:</span>
                                <span class="valor-contacto">1234567890</span>
                            </div>
                        </div>
                        ...
                        <div class="item-contacto">
                            ...
                            <div class="info-contacto">
                                ...
                                <span class="valor-contacto">Carrera 15 #85-23, Zona Rosa, Bogotá</span>
                            </div>
                        </div>
                        ...
                        <div class="item-contacto">
                            ...
                            <div class="info-contacto">
                                ...
                                <span class="valor-contacto">+57 6015551234</span>
                            </div>
                        </div>
                        ...
                        <div class="item-contacto">
                            ...
                            <div class="info-contacto">
                                ...
                                <span class="valor-contacto">info@lodgehubplaza.com</span>
                            </div>
                        </div>
