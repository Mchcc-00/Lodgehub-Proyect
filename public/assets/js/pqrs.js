document.addEventListener('DOMContentLoaded', function() {
    ...
    async function validarUsuario() {
        ...
        try {
            const response = await fetch(`../controllers/pqrsController.php?action=validarUsuario&numDocumento=${encodeURIComponent(numDocumento)}`);
    ...
    async function handleSubmit(e) {
        ...
        try {
            ...
            const formAction = form.action || '../controllers/pqrsController.php';
...
async function cargarPqrs(pagina = 1, registrosPorPagina = 10, filtro = null) {
    try {
        let url = `../controllers/pqrsController.php?action=obtener&paginado=true&pagina=${pagina}&registros=${registrosPorPagina}`;
        if (filtro) {
...
async function obtenerPqrsPorId(id) {
    try {
        const url = `../controllers/pqrsController.php?action=obtenerPorId&id=${encodeURIComponent(id)}`;
        const response = await fetch(url);
        const result = await response.json();
...
async function actualizarPqrs(id, datos) {
    try {
        ...
        const response = await fetch('../controllers/pqrsController.php?action=actualizar', {
            method: 'POST',
            body: formData
        });
...
async function eliminarPqrs(id) {
    try {
        ...
        const response = await fetch('../controllers/pqrsController.php?action=eliminar', {
            method: 'POST',
            body: formData
        });
...
async function buscarPqrs(termino) {
    try {
        const url = `../controllers/pqrsController.php?action=buscar&termino=${encodeURIComponent(termino)}`;
        const response = await fetch(url);
        const result = await response.json();
